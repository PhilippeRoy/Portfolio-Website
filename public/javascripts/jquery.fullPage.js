	...
	$.fn.fullpage = function(options) {
		...
		*/
		...
		function scrollPage(element, callback, isMovementUp){
			...
			var dtop = (dest.top/totalHeight)*100;
			...
			if (options.css3 && options.autoScrolling) {
				...
				var translate3d = 'translate3d(0, -' + dtop + '%, 0)';
		...
		*/
		...
		function getTransforms(translate3d){
			return {
				...
				"-webkit-transition": "all " + options.scrollingSpeed + "ms " + options.easing,
				"-moz-transform": translate3d, 
        		"-moz-transition": "all " + options.scrollingSpeed + "ms " + options.easing,
        		"-ms-transform": translate3d, 
        		"-ms-transition": "all " + options.scrollingSpeed + "ms " + options.easing,
        		"transform": translate3d, 
        		"transition": "all " + options.scrollingSpeed + "ms " + options.easing
			};
		}
